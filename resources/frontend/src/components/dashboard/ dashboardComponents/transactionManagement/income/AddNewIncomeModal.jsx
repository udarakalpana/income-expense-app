    ...
    return (
        <div
            ...
            className={
                !isModalOpen
                    ? "hidden"
                    : "mt-9 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
            }
        >
                            ...
                            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="side project">
                                            Side Project
                                        </option>
                                        <option value="youtube revenue">
                                            YouTube Revenue
                                        </option>
                                    </select>
                                    {isIncomeCategoryFieldEmpty && (
...
export default AddNewIncomeModal;
